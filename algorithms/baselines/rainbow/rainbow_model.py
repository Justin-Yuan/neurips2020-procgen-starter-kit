...
class BaselineRainbowTorchModel(TorchModelV2, nn.Module):
    ...
    def __init__(
            ...
            *,
            ...
            # necessary for distributional rainbow 
            num_atoms=1,
            v_min=-10.0,
            v_max=10.0,
            #  customs 
        ...
        super(BaselineRainbowTorchModel, self).__init__(obs_space, action_space,
...
ModelCatalog.register_custom_model("baseline_rainbow", BaselineRainbowTorchModel)
